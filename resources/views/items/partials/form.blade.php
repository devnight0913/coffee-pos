    ...
    <div class="row">
        <div class="col-md-6 d-flex align-items-stretch mb-3">
            <x-card>
                ...
                <x-select label="Supplier" name="supplier" :searchable="true">
                    @isset($item)
        ...
        <div class="col-md-6 d-flex align-items-stretch mb-3">
            <x-card>
                ...
                <x-select label="Unit" name="unit">
                    @isset($item)
                        <option value="1" @if ($item->unit === 1) selected @endif>
                            gr
                        </option>
                        <option value="2" @if ($item->unit === 2) selected @endif>
                            ps
                        </option>
                        <option value="3" @if ($item->unit === 3) selected @endif>
                            ml
                        </option>
                        <option value="4" @if ($item->unit === 3) selected @endif>
                            kg
                        </option>
                    @else
